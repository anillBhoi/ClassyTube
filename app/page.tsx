  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans overflow-hidden">
      ...
      <header className="relative z-10 w-full py-5 px-6">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-background rounded-lg px-4 py-2 shadow-sm border border-border">
              <div className="w-8 h-8 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center">
                <Play className="h-5 w-5 text-white" fill="currentColor" />
              </div>
              <span className="text-xl font-bold tracking-tight">ClassyTube</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <ThemeToggle />
            {user ? (
              <Link href="/dashboard">
                <Button variant="ghost" size="icon" className="rounded-full bg-background hover:bg-accent border border-border">
      ...
      <main className="relative z-10 container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="#features">
                  <Button variant="outline" className="rounded-full px-8 py-4 border-border transition-all flex items-center gap-2">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-background p-2 rounded-2xl shadow-lg border border-border transform rotate-2 overflow-hidden">
                  <div className="w-full h-64 relative rounded-xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 flex items-center justify-center">
                      <div className="text-center p-4">
                        ...
                        <p className="text-sm font-medium text-blue-800 dark:text-blue-200">Dashboard Preview</p>
                      </div>
                    </div>
                ...
                <div className="bg-background p-2 rounded-2xl shadow-lg border border-border transform -rotate-1 mt-8 overflow-hidden">
                  <div className="w-full h-56 relative rounded-xl overflow-hidden">
                    {/* Replace this with your actual progress tracking image */}
                    <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 flex items-center justify-center">
                      <div className="text-center p-4">
                        <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-2">
                          <BookOpen className="h-5 w-5 text-white" />
                        </div>
                        <p className="text-xs font-medium text-green-800 dark:text-green-200">Progress Tracking</p>
                      </div>
                    </div>
                ...
                <div className="bg-background p-2 rounded-2xl shadow-lg border border-border transform rotate-3 col-span-2 overflow-hidden">
                  <div className="w-full h-48 relative rounded-xl overflow-hidden">
                    {/* Replace this with your actual AI features image */}
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 flex items-center justify-center">
                      <div className="text-center p-4">
                        ...
                        <p className="text-sm font-medium text-purple-800 dark:text-purple-200">AI Features</p>
                      </div>
                    </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-yellow-200/60 dark:bg-yellow-900/30 rounded-full blur-xl opacity-40 z-0"></div>
              <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-blue-200/60 dark:bg-blue-900/30 rounded-full blur-xl opacity-30 z-0"></div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-background p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
                ...
                <p className="text-muted-foreground">Turn any YouTube playlist into a organized course with clear milestones and objectives.</p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
                ...
                <p className="text-muted-foreground">Monitor your learning journey with visual progress indicators and completion metrics.</p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
                ...
                <p className="text-muted-foreground">Get automatic summaries, quizzes, and assignments generated from video content.</p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
                ...
                <p className="text-muted-foreground">Bookmark your favorite learning content and create personalized collections.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* How it works */}
        <section className="py-16 bg-background rounded-3xl shadow-sm border border-border mb-16">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">How LearnTube works</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">Copy any YouTube playlist link</p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">Set your learning preferences</p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">Start your structured course</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="relative z-10 container mx-auto px-6 py-8 text-center text-muted-foreground text-sm">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="font-medium">ClassyTube</span>
        </div>
