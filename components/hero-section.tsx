...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-black py-20 md:py-32">
      ...
      <div className="absolute inset-0 bg-gradient-radial from-red-600/30 via-transparent to-transparent" />
      ...
      <div className="absolute bottom-40 right-20 animate-float-horizontal-reverse">
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-red-600/20 p-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-8 w-8 text-red-500"
